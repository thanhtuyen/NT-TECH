                ...
                <div class="tab-inner">
                  <table class="form"> 
                      ...
                      <tr>
						...
						<?php //today deal?>
						<tr>
							<td><?php echo $this->language->get('entry_today_deal'); ?></td>
							<td>
...
function addModule() {
  ...
  html += '                                <td><select name="pavdeals_module[' + module_row + '][category_ids][]" id="pavdeals_module_' + module_row + '_category_ids" multiple="multiple" size="10">';
                                     <?php foreach ($categories as $category) { ?>
  html += '                                 <option value="<?php echo $category['category_id']; ?>" <?php if(empty($category['category_id'])): ?>  onclick="selectAll(\'#pavdeals_module_' + module_row + '_category_ids\');" <?php endif;?>><?php echo $category['name']; ?></option>';
                                      <?php } ?>
  html += '                                  </select></td>';
  html += '                              </tr>';
  html += '                              <tr>';
