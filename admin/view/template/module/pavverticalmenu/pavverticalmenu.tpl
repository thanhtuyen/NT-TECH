							...
							<div class="verticalmenu-form">
								...
								<table class="form">
									<tr>
									  ...
									  <td><select name="pavverticalmenu_module[<?php echo $module_row; ?>][layout_id]">
									...
									<tr>
									  ...
									  <td><select name="pavverticalmenu_module[<?php echo $module_row; ?>][position]">
									...
									<tr>
									  ...
									  <td><select name="pavverticalmenu_module[<?php echo $module_row; ?>][status]">
									...
									<tr>
									  ...
									  <td><input type="text" name="pavverticalmenu_module[<?php echo $module_row; ?>][sort_order]" value="<?php echo $module['sort_order']; ?>" size="3" /></td>
									</tr>
										</table>
