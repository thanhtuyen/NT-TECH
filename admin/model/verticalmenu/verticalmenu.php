...
class ModelVerticalmenuVerticalmenu extends Model { 
	...
	public function genTree( $parent, $level ){
		if( $this->hasChild($parent) ){
			...
			foreach( $data as $menu ){
				$url  = $this->url->link('module/pavverticalmenu', 'id='.$menu['verticalmenu_id'].'&token=' . $this->session->data['token'], 'SSL') ;
	...
	public function delete( $id ){
		...
		$sql = " DELETE FROM ".DB_PREFIX ."verticalmenu WHERE verticalmenu_id=".(int)$id ;
		$this->db->query( $sql );
		$sql = " DELETE FROM ".DB_PREFIX ."verticalmenu_description WHERE verticalmenu_id=".(int)$id ;
		$this->db->query( $sql );
