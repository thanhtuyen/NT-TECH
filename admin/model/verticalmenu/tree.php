...
class ModelVerticalmenuTree extends Model {		
	 ...
	 *
	 */
	public function getTree( $parent=1 , $edit=false, $params ){
		...
		foreach( $menu['megaconfig']->rows  as $row ){
			...
			$output .= '<div class="row">';
				foreach( $row->cols as $col ){
					 $output .= '<div class="mega-col col-md-'.$col->colwidth.'" '.$this->getColumnDataConfig( $col ).'> <div>';
						...
						foreach( $rows as $rowcols ){
							...
							foreach( $rowcols as $key => $col ) {
								...
								if( isset($col->type) && $col->type == 'menu' && isset($cols[$key]) ){
									$scol = '<div class="mega-col col-md-'.$col->colwidth.'" data-type="menu" '.$this->getColumnDataConfig( $col ).'><div class="inner">';
									$scol .= '<ul>';
									...
									$scol = '<div class="mega-col col-md-'.$col->colwidth.'"  '.$this->getColumnDataConfig( $col ).'><div class="inner">';
