...
<div id="content" class="pavquickview"><?php echo $content_top; ?>
  ...
  <div class="product-info">
    ...
    <div class="left">
      ...
      <?php } ?>
      <?php if ($images) { ?>
      <div class="image-additional list_carousel" id="image-additional">
         <ul id="pav-image-additional">
        <?php 
       ...
       <div class="carousel-control left prev" href="#image-additional" id="prev_image_additional">&lsaquo;</div>
       <div class="carousel-control right next" href="#image-additional" id="next_image_additional">&rsaquo;</div>
      </div>
      <?php } ?>
    </div>
    <?php } ?>
